...
class Persona(ABC):
    @abstractclassmethod # con este decorador le indicamos que la clase es abstracta
    ...
    @abstractclassmethod # con este decorador le indicamos que el metodo es abstracto
    def hacer_actividad(self):
        pass

    def presentarse(self): # si no le indicamos nada significa que el metododo es generico
