...
diff_lento = round(100 - este_curso / curso_maximo * 100, 2)
diff_promedio = 100 - este_curso / curso_promedio * 100

print("--------------------")
print("El curso de Dalto dura:")
print(f"- Un {diff_rapido} % menos que el curso mas rapido")
print(f"- Un {diff_lento} % menos que el curso mas lento")
print(f"- Un {diff_rapido} % menos que la duracion promedio de los demas cursos")
print("--------------------")
# b)
...
tiempo_vacio_dalto = round(100 - este_curso / crudo_dalto * 100, 2)
